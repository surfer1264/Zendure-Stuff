...
Eine MQTT.yaml (https://github.com/surfer1264/Zendure-Stuff/blob/main/mqtt.yaml.txt) ist im Codebereich angefügt und enthält die Werte minVol, maxVol, SOC Level, Akkutemperatur und weitere (Danke an bzach).
