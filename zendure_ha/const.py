...
class SmartMode:
    ...
    DISCHARGE_OPTIMAL_DIVISOR = 2.7      # Divisor for discharge_optimal (default 4)
    DISCHARGE_START_DIVISOR = 7       # Divisor for discharge_start  (default 10)
    CHARGE_OPTIMAL_DIVISOR = 2.7         # Divisor for charge_optimal (default 4)
    CHARGE_START_DIVISOR = 7          # Divisor for charge_start  (default 10)
    # %-Punkte SoC-Differenz, ab der ein Idle-Gerät bevorzugt dem aktiven Gerät mit ungünstigerem SoC vorgezogen wird
    SOC_BALANCE_MARGIN = 5  # %-Punkte SoC-Differenz, ab der ein Idle-Gerät bevorzugt (devault 3)
